	...
	return (
		<div id='accordion-color' data-accordion='collapse' data-active-classes='bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white'>
			...
			<div id='accordion-color-body-1' className='' aria-labelledby='accordion-color-heading-1'>
				<div className='p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900'>
					...
					<p className='text-gray-500 dark:text-gray-400'>
						...
						<a href='https://flowbite.com/docs/getting-started/introduction/' className='text-blue-600 dark:text-blue-500 hover:underline'>
							get started
						</a>{" "}
			...
			<h2 id='accordion-color-heading-3'>
				<button
					type='button'
					className='flex justify-between items-center p-5 w-full font-medium text-left text-gray-500 border border-gray-200 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800'
			...
			<div id='accordion-color-body-3' className='hidden' aria-labelledby='accordion-color-heading-3'>
				<div className='p-5 border border-t-0 border-gray-200 dark:border-gray-700'>
					<p className='mb-2 text-gray-500 dark:text-gray-400'>
						The main difference is that the core components from Flowbite are open source under the MIT license, whereas Tailwind UI is a paid product. Another difference is that Flowbite relies on smaller and standalone components, whereas Tailwind
